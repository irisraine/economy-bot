...
def slot_machine():
    embed_message = MessageContainer(
        ...
        description=f"Испытай свою удачу в игре с одноруким бандитом и сорви свой джекпот! Выбирай между двумя "
                    ...
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['white']['low']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['orange']['low']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['all_colors']['low']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['green']['low']}** {FROG_EMOJI}\n\n"
                    f"- **Отчаянный ковбой** "
                    ...
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['gold']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['gold']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['gold'][3]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['cart']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['cart']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['cart']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['cart'][3]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['star']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['star']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['star']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['star'][3]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['horseshoe']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['horseshoe']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['horseshoe']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['horseshoe'][3]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['moonshine']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['moonshine']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['moonshine']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['moonshine'][3]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['white']['high']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['gold']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['gold']['emoji']} :x:** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['gold'][2]}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['orange']['high']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_orange']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_white']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['all_colors']['high']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']} "
                    f"{config.SLOT_MACHINE_REEL_SYMBOLS['frog_green']['emoji']}** "
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['frogs']['green']['high']}** {FROG_EMOJI}\n"
                    f"**{config.SLOT_MACHINE_REEL_SYMBOLS['gold']['emoji']} :x: :x:**"
                    f" - выплата **{config.SLOT_MACHINE_PAYOUT_AMOUNTS['rare_symbols']['gold'][1]}** {FROG_EMOJI}\n\n"
