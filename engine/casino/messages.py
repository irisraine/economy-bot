...
def slot_machine():
    embed_message = MessageContainer(
        ...
        description=f"Испытай свою удачу в игре с одноруким бандитом и сорви свой джекпот! Выбирай между двумя "
                    f"режимами игры: более доступной «Трехлапой жабой» и дорогим «Золотом прерий», каждый из которых "
...
def slot_machine_result(player, reels, bet, payout, image_binary_data):
    ...
    if payout == 0:
        ...
        title = "Фортуна осталась нейтральной"
        description += (f"На центральной линии не сложилось ни одной из выигрышных комбинаций - тем не менее, благодаря "
                        ...
                        f"Не сдавайся! Может быть, следующий спин принесет тебе удачу? 🍀")
    elif payout < 50:
