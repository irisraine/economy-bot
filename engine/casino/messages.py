...
def yahtzee():
    embed_message = MessageContainer(
        ...
        description=f"Добро пожаловать в покер на костях — игру, где прихотливые законы вероятностей и стратегия идут "
                    ...
                    f"- **Малый стрит** (последовательность из четырех чисел): **0.3:1**\n"
                    f"- **Фулл-хаус** (пара и тройка с одинаковыми значениями): **0.5:1**\n"
                    f"- **Каре** (четыре кости с одинаковым значением): **1:1**\n"
